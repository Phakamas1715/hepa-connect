...
ผู้ใช้ SuperGrok/X Premium+ สามารถ login ด้วยบัญชีสมาชิกโดยไม่ต้องใช้ API key แต่ไม่ควร login
บน production VPS ที่เก็บข้อมูลผู้ป่วย ให้ใช้งานจากเครื่องผู้ดูแลแทน ห้ามส่ง HN, CID, LINE user ID,
ผลตรวจ หรือไฟล์ `.env` เข้า Grok
